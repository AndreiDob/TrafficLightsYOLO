'''
***************************************************************************************
*    Title: Dataset source code
*    Authors: Andreas Fregin, Julian Mueller and Klaus Dietmayer
*    Date: 2020
*    Code version: 27
*    Availability: https://github.com/julimueller/dtld_parsing
*
***************************************************************************************
'''

from __future__ import print_function
from preprocessing.dtld_parsing.calibration import CalibrationData
from preprocessing.dtld_parsing.vehicle_data import VehicleData
...
class DriveuDatabase:
    ...
    def open(self, data_base_dir: str = ""):
        ...
        if os.path.exists(self.file_path) is not None:
            ...
            images = yaml.safe_load(open(self.file_path, "rb").read())
        else:
            logging.exception(
